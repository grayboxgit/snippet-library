...
var data = {
    "posts": [
        ...
        },
        {
            "title": "Nav Read",
            "rendered_output": "index.html",
            "jade_source": "/snippets/001-nav-01/jade/*.jade",
            "html_source": "/snippets/001-nav-01/html/*.html",
            "scss_source": "/snippets/001-nav-01/scss/*.scss",
            "js_source": "/snippets/001-nav-01/js/*.js"
        }
    ]
};
